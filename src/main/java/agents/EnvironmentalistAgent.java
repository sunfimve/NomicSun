...
public class EnvironmentalistAgent extends NomicAgent {

	public EnvironmentalistAgent(UUID id, String name) {
		super(id, name);
		Type = AgentType.ENVIRONMENTALIST;
	...
	public String getProxyRulesFile() {
		return "src/main/resources/EnvironmentalistProxy.drl";
	}
}
